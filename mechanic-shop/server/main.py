...
from routers import tires, logs, threshold, items

app = FastAPI(title="Tire Inventory API", redirect_slashes=False)

# Allowed origins for cross-domain requests
origins = [
    "https://app.leetcodetutor.com",  # your frontend domain
]
